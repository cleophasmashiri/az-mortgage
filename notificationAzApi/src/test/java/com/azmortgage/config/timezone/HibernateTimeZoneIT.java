package com.azmortgage.config.timezone;

import com.azmortgage.NotificationAzApiApp;
import com.azmortgage.config.SecurityBeanOverrideConfiguration;
import com.azmortgage.repository.timezone.DateTimeWrapper;
import com.azmortgage.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, NotificationAzApiApp.class})
